              ...
              items: [
                {
                  type: 'smallItem',
                  label: '8pm',
                  picto: '<img src="assets/img/doormat.png" />',
                  shortContent: 'Welcoming schmoozing'
                },
                {
                  type: 'smallItem',
                  label: '9pm',
                  picto: '<img src="assets/img/speaking.png" />',
                  shortContent: '<strong>Announcements :</strong> The Open Culture Foundation will launch its Civic Hack News website. OpenDemocracyNow! will kick off the OGP Toolbox hackathon.'
                },
                {
                  type: 'smallItem',
                  label: '9:30pm',
                  picto: '<img src="assets/img/bolt.png" />',
                  shortContent: '<strong>Lighning talks :</strong> '
                },
                {
                  type: 'smallItem',
                  label: '1Opm',
                  picto: '<img src="assets/img/doormat.png" />',
                  shortContent: 'Drinks, food and music !'
                },
              ]
            });
}(jQuery));
